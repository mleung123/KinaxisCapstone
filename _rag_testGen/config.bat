@echo off
REM Auto-generated. Edit if needed.
...
set "SME_MODEL=qwen2.5-7b-instruct-uncensored"
set "REVIEW_MODEL=qwen2.5-7b-instruct-uncensored"
set "LMSTUDIO_LOGPATH=C:\Users\kadek\AppData\Roaming\LM Studio\logs\main.log"
